...
.filter-recreated .pokeball-mark{{--finish-icon:url("assets/finish-patterns/pokeball.svg?v=1390899-button-ring")}}.filter-recreated .masterball-mark{{--finish-icon:url("assets/finish-patterns/masterball.svg")}}.filter-recreated .loveball-mark{{--finish-icon:url("assets/finish-patterns/loveball.svg")}}.filter-recreated .friendball-mark{{--finish-icon:url("assets/finish-patterns/friendball.svg")}}.filter-recreated .quickball-mark{{--finish-icon:url("assets/finish-patterns/quickball.svg")}}.filter-recreated .duskball-mark{{--finish-icon:url("assets/finish-patterns/duskball.svg")}}.filter-recreated .rocket-mark{{--finish-icon:url("assets/finish-patterns/teamrocket.svg")}}
...
.filter-recreated .energy-grass{{--energy-vector:url("assets/finish-patterns/energy-grass.svg")}}.filter-recreated .energy-fire{{--energy-vector:url("assets/finish-patterns/energy-fire.svg")}}.filter-recreated .energy-water{{--energy-vector:url("assets/finish-patterns/energy-water.svg")}}.filter-recreated .energy-lightning{{--energy-vector:url("assets/finish-patterns/energy-lightning.svg")}}.filter-recreated .energy-psychic{{--energy-vector:url("assets/finish-patterns/energy-psychic.svg")}}.filter-recreated .energy-fighting{{--energy-vector:url("assets/finish-patterns/energy-fighting.svg")}}.filter-recreated .energy-darkness{{--energy-vector:url("assets/finish-patterns/energy-darkness.svg")}}.filter-recreated .energy-metal{{--energy-vector:url("assets/finish-patterns/energy-metal.svg")}}.filter-recreated .energy-dragon{{--energy-vector:url("assets/finish-patterns/energy-dragon.svg")}}.filter-recreated .energy-fairy{{--energy-vector:url("assets/finish-patterns/energy-fairy.svg")}}.filter-recreated .energy-colorless,.filter-recreated .energy-trainers,.filter-recreated .energy-energy,.filter-recreated .energy-secret-rares{{--energy-vector:url("assets/finish-patterns/energy-colorless.svg")}}
...
<script>
const DATASETS={datasets},PRICE_CATALOG={prices};let active=DATASETS[0],activeFormatId='3x3',index=0,renderMode='scan';
