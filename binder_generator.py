...
const SHOWCASE_LABELS={{pokeball:'Poké Ball',masterball:'Master Ball',loveball:'Love Ball',friendball:'Friend Ball',quickball:'Quick Ball',duskball:'Dusk Ball',teamrocket:'Team Rocket',energy:'Energy'}};
