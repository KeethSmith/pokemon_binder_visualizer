...
.filter-recreated .pokeball-mark,.filter-recreated .masterball-mark,.filter-recreated .loveball-mark,.filter-recreated .friendball-mark,.filter-recreated .quickball-mark,.filter-recreated .duskball-mark{{width:50.4%;top:51%}}
.filter-recreated .finish-mark::before,.filter-recreated .finish-mark::after{{content:none}}
.filter-recreated .pokeball-mark{{--finish-icon:url("assets/finish-patterns/pokeball.svg?v=normalized-v1")}}.filter-recreated .masterball-mark{{--finish-icon:url("assets/finish-patterns/masterball.svg?v=m-plus-20-v13")}}.filter-recreated .loveball-mark{{--finish-icon:url("assets/finish-patterns/loveball.svg?v=normalized-v1")}}.filter-recreated .friendball-mark{{--finish-icon:url("assets/finish-patterns/friendball.svg?v=normalized-v1")}}.filter-recreated .quickball-mark{{--finish-icon:url("assets/finish-patterns/quickball.svg?v=normalized-v1")}}.filter-recreated .duskball-mark{{--finish-icon:url("assets/finish-patterns/duskball.svg?v=normalized-v1")}}.filter-recreated .rocket-mark{{--finish-icon:url("assets/finish-patterns/teamrocket.svg")}}
