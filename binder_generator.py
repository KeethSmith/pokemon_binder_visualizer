...
def render_html(config: dict[str, Any], cards: list[Card]) -> str:
    ...
    holo_opacity = min(0.75, max(0.0, float(appearance.get("holographic_opacity", 0.52))))
...
.pocket img{{display:block;width:100%;height:100%;object-fit:contain;border-radius:7px}}.holographic{{border-color:rgba(112,132,118,.72);box-shadow:0 0 18px rgba(0,0,0,.65),inset 0 0 12px rgba(120,140,125,.1)}}.holographic img{{filter:brightness(.92) saturate(.92) contrast(1.04)}}
...
.holographic::after{{background-image:linear-gradient(125deg,rgba(255,255,255,.1) 0%,rgba(22,30,24,.48) 19%,rgba(0,0,0,.72) 39%,rgba(150,165,145,.14) 51%,rgba(0,0,0,.64) 69%,rgba(255,255,255,.08) 100%),repeating-linear-gradient(115deg,transparent 0 11px,rgba(8,14,10,.24) 12px,transparent 15px);background-size:100% 100%;mix-blend-mode:soft-light;opacity:{holo_opacity}}}
