...
.holographic::after{{background-image:linear-gradient(125deg,rgba(255,255,255,.1) 0%,rgba(22,30,24,.42) 18%,rgba(0,0,0,.64) 37%,rgba(225,238,230,.42) 48%,rgba(105,122,110,.18) 54%,rgba(0,0,0,.56) 69%,rgba(255,255,255,.1) 100%),repeating-linear-gradient(115deg,transparent 0 11px,rgba(8,14,10,.2) 12px,rgba(210,225,215,.1) 13px,transparent 16px);background-size:100% 100%;mix-blend-mode:soft-light;opacity:{holo_opacity}}}
