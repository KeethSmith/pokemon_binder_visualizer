...
@media(max-width:700px){{header{{padding:6px 9px}}.bar{{display:block}}.header-row{{display:flex;align-items:center;justify-content:space-between;gap:8px}}h1{{margin:0;font-size:17px;white-space:nowrap}}#controlsToggle{{display:block;padding:4px 8px;font-size:12px}}.controls{{display:none;padding-top:6px;gap:5px 8px;align-items:center;justify-content:center;flex-wrap:wrap}}.controls.open{{display:flex}}.controls label{{font-size:12px}}.controls select{{padding:4px 6px;font-size:12px}}.page{{gap:6px;padding:8px}}.tag{{inset:auto 4px 4px;font-size:9px;padding:3px}}}}@media print{{header,.page-nav,.note{{display:none}}body{{background:white;color:black}}main{{margin:0}}.page{{box-shadow:none;break-after:page}}}}
</style></head><body>
