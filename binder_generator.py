...
button,select{{color:var(--ink);background:#243449;border:1px solid #4a607a;border-radius:8px;padding:6px 9px;font-weight:650}}button:hover{{border-color:var(--accent);cursor:pointer}}button:disabled{{opacity:.42;cursor:not-allowed}}.page-nav{{display:flex;justify-content:space-between;gap:12px;margin:0 0 12px}}
