...
<main><p class="summary">{escape(summary)}</p><div class="page-head"><h2 id="title"></h2><span id="count"></span></div><nav class="page-nav" aria-label="Binder pages"><button id="prev">← Previous</button><button id="next">Next →</button></nav><section class="page" id="page"></section><p class="note">Images load from the URL template configured for this set. Pocket labels identify card variants that share an image.</p></main>
