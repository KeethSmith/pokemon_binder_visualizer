...
class GeneratorTests(unittest.TestCase):
    ...
    def test_special_finish_showcase_controls_are_built_in(self):
        ...
        self.assertIn("energy:'Energy'", html)
        self.assertNotIn("Energy Symbol'", html)
        self.assertNotIn("Poké Ball pattern", html)
        self.assertNotIn("Energy Symbol Pattern", html)
        self.assertIn('<span class="card-name"> ${card.name}</span>', html)
        self.assertIn(".tag .card-name{display:none}", html)
